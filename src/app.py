...
#      # User input section
#     date = st.date_picker("Date")  # Use date_picker
#     selected_date = datetime.datetime(date.year, date.month, date.day)  # Extract year, month, and day
...
#         # st.write("Expected Features:", numeric_features + list(encoder.get_feature_names_out(categorical_features)))
...
# input_df, encoder, scaler, numeric_features, categorical_features = load_model()
...
<style>
    ...
    # User input section
    date = st.date_picker("Date")  # type: ignore # Use date_picker
    selected_date = datetime.datetime(date.year, date.month, date.day)  # Extract year, month, and day
