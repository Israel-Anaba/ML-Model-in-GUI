...
# # Define and initialize preprocessing components
...
# with open('src/Asset/ML_Comp/exported_data.pkl', 'wb') as file:
#     pickle.dump(exported_data, file)

# # Load the preprocessing components from the exported data
# def load_preprocessing_components():
#     with open('src/Asset/ML_Comp/exported_data.pkl', 'rb') as file:
#         exported_data = pickle.load(file)
#     encoder = exported_data['encoder']
#     scaler = exported_data['scaler']
#     num_imputer = exported_data['numerical_imputer']
#     cat_imputer = exported_data['categorical_imputer']
#     return encoder, scaler, num_imputer, cat_imputer
#          # Unpack the components from the list
    # encoder = exported_data['encoder'][0]
    # scaler = exported_data['scaler'][0]
    # num_imputer = exported_data['numerical_imputer'][0]
    # cat_imputer = exported_data['categorical_imputer'][0]
    # return encoder, scaler, num_imputer, cat_imputer
